...
|:-----------------------------------------------------------------------------:|:-----------------------------------------------------------------------------:|:-----------------------------------------------------------------------------:|:-----------------------------------------------------------------------------:|:-----------------------------------------------------------------------------:|:-----------------------------------------------------------------------------:|
| <img src="https://avatars.githubusercontent.com/u/62222791?v=4" width="120"/> | <img src="https://avatars.githubusercontent.com/u/62222791?v=4" width="120"/> | <img src="https://avatars.githubusercontent.com/u/163365711?v=4" width="120"/> | <img src="https://avatars.githubusercontent.com/u/44632544?v=4" width="120"/> | <img src="https://avatars.githubusercontent.com/u/62222791?v=4" width="120"/> | <img src="https://avatars.githubusercontent.com/u/84345021?v=4" width="120"/> |
|                                 **팀장, Infra**                                 |                                   **Front**                                   |                                   **Back**                                    |                                   **Back**                                    |                                   **Front**                                   |                                 **Front**                                  |
|              [@potential1205](https://github.com/potential1205)               |              [@potential1205](https://github.com/potential1205)               |              [@serimmmaime](https://github.com/serimmmaime)               |              [@LeeSeongHui](https://github.com/LeeSeongHui)               |              [@potential1205](https://github.com/potential1205)               |              [@joeholee](https://github.com/joeholee)               |
...
| 김도희          | 팀원, <br /> Frontend | - |
| 예세림          | 팀원, <br /> Backend  | - **팬 토큰 거래소 로직 개발:** 팬 토큰 교환, 예치, 회수 기능을 스마트 컨트랙트로 구현하고 Web3j와 연동<br> - **AMM 구조 설계:** x*y=k 기반 자동 가격 조정 로직 적용 및 초기 유동성 구성<br> - **리워드풀 구현:** 경기 예측, DAO 투표 등 보상 분배를 위한 컨트랙트 작성 및 트랜잭션 처리<br> - **거래 상태 처리:** 트랜잭션 발생 시 PENDING 상태로 표시하고 컨펌 결과를 주기적으로 반영<br> - **API 연동 기준 정리:** 프론트와의 연동을 고려해 거래 흐름과 예외 처리 기준을 문서화 및 공유 |
...
### 1. 팬 토큰 거래소 (AMM 기반)
<img src="https://github.com/user-attachments/assets/512f4c59-c445-4c44-a14c-9e8e0ec5ddff">
<br>
**실시간 가격 변동**
...
![기능1 이미지](https://github.com/user-attachments/assets/512f4c59-c445-4c44-a14c-9e8e0ec5ddff)
...
![기능2 이미지1](https://github.com/user-attachments/assets/ddbcd7cd-c68f-4362-a5aa-143334a87d9b)
![기능2 이미지2](https://github.com/user-attachments/assets/b2fceac6-d840-4d4e-8f9f-6e815f6cf4cd)
